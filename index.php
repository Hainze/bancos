...
$tools = [
    ...
    [
        'id'          => 'iva',
        'nombre'      => 'Libro IVA',
        'descripcion' => 'Registro de compras y ventas, alícuotas, presentaciones AFIP y libro digital.',
        'icono'       => '📋',
        'color'       => 'purple',
        'url'         => '#',
        'badge'       => 'Próximamente',
    ...
    [
        'id'          => 'impuestos',
        'nombre'      => 'Impuestos',
        'descripcion' => 'Seguimiento de vencimientos, anticipos de ganancias, autónomos e ingresos brutos.',
        'icono'       => '📊',
        'color'       => 'red',
        'url'         => '#',
        'badge'       => 'Próximamente',
    ...
    [
        ...
        'descripcion' => 'Dashboard ejecutivo con datos de todas las herramientas: flujo de caja, estado de resultados y más.',
        'icono'       => '📈',
        'color'       => 'cyan',
        'url'         => '#',
        'badge'       => 'Próximamente',
