...
<head>
    ...
    <title><?= isset($titulo) ? $titulo . ' — ' : '' ?>Facturación · SmartAdmin</title>
    ...
    <style>
        ...
        .cliente-badge-sidebar .cb-dot {
            width: 7px; height: 7px; border-radius: 50%;
            background: var(--green); flex-shrink: 0;
        }
        .cliente-badge-sidebar .cb-nombre {
    ...
    <aside class="sidebar" id="sidebar">
        <div class="sidebar-brand">
            ...
            <div>
                ...
                <div class="brand-sub">Facturación</div>
            </div>
        </div>
        ...
        <?php else: ?>
        <div class="cliente-vacio-sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <a href="/facturacion/index.php" class="nav-item <?= $pagina_actual === 'index' ? 'active' : '' ?>">
                <span class="nav-icon">◈</span>
                <span>Seleccionar Cliente</span>
            </a>
            <a href="/facturacion/clientes.php" class="nav-item <?= $pagina_actual === 'clientes' ? 'active' : '' ?>">
                <span class="nav-icon">≡</span>
                <span>Gestión de Clientes</span>
            </a>

            <div class="nav-section-label">Comprobantes</div>
            <a href="/facturacion/compras.php" class="nav-item <?= $pagina_actual === 'compras' ? 'active' : '' ?>"
               <?= !$fact_cliente_id ? 'style="opacity:0.5;pointer-events:none"' : '' ?>>
                <span class="nav-icon">⬇</span>
                <span>Compras</span>
            </a>
            <a href="/facturacion/ventas.php" class="nav-item <?= $pagina_actual === 'ventas' ? 'active' : '' ?>"
               <?= !$fact_cliente_id ? 'style="opacity:0.5;pointer-events:none"' : '' ?>>
                <span class="nav-icon">⬆</span>
                <span>Ventas</span>
            </a>
            ...
            <a href="/facturacion/informes.php" class="nav-item <?= $pagina_actual === 'informes' ? 'active' : '' ?>"
               <?= !$fact_cliente_id ? 'style="opacity:0.5;pointer-events:none"' : '' ?>>
                <span class="nav-icon">📊</span>
                <span>Informes</span>
            </a>
        ...
        <div class="sidebar-footer">
            ...
            <div class="banco-badge" style="margin-top:10px">
                <span class="banco-dot" style="background:var(--green)"></span>
    ...
    <main class="main-content">
        <div class="topbar">
            <div class="topbar-left">
                ...
                <h1 class="page-title"><?= isset($titulo) ? $titulo : 'Facturación' ?></h1>
            </div>
            <div class="topbar-right">
                <?php if ($fact_cliente_id): ?>
                <span style="font-size:12px;color:var(--green);padding:4px 12px;background:rgba(16,185,129,0.1);border:1px solid rgba(16,185,129,0.2);border-radius:20px">
