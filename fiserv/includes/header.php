...
<head>
    ...
    <title><?= isset($titulo) ? $titulo . ' — ' : '' ?>Fiserv · SmartAdmin</title>
    ...
    <aside class="sidebar" id="sidebar">
        <div class="sidebar-brand">
            ...
            <div>
                ...
                <div class="brand-sub">Fiserv</div>
            </div>
        </div>

        <nav class="sidebar-nav">
            <div class="nav-section-label">Principal</div>
            <a href="/fiserv/index.php" class="nav-item <?= $pagina_actual === 'index' ? 'active' : '' ?>">
                <span class="nav-icon">◈</span>
                <span>Dashboard</span>
            </a>
            <a href="/fiserv/procesar.php" class="nav-item <?= $pagina_actual === 'procesar' ? 'active' : '' ?>">
                <span class="nav-icon">⬆</span>
                <span>Subir PDF</span>
            </a>
            <a href="/fiserv/reportes.php" class="nav-item <?= $pagina_actual === 'reportes' ? 'active' : '' ?>">
                <span class="nav-icon">◎</span>
                <span>Reportes</span>
            </a>
        ...
        <div class="sidebar-footer">
            ...
            <div class="banco-badge" style="margin-top:10px">
                <span class="banco-dot" style="background:#f59e0b"></span>
                <span>Tarjetas Fiserv</span>
            </div>
        </div>
    </aside>
