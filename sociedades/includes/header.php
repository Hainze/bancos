...
<head>
    ...
    <title><?= isset($titulo) ? $titulo . ' — ' : '' ?>Sociedades · SmartAdmin</title>
    ...
    <aside class="sidebar" id="sidebar">
        <div class="sidebar-brand">
            ...
            <div>
                ...
                <div class="brand-sub">Sociedades</div>
            </div>
        </div>

        <nav class="sidebar-nav">
            <div class="nav-section-label">Principal</div>
            <a href="/sociedades/index.php" class="nav-item <?= $pagina_actual === 'index' ? 'active' : '' ?>">
        ...
        <div class="sidebar-footer">
            ...
            <div class="banco-badge" style="margin-top:10px">
                ...
                <span>Balances Societarios</span>
            </div>
        </div>
    </aside>
    ...
    <main class="main-content">
        <div class="topbar">
            <div class="topbar-left">
                ...
                <h1 class="page-title"><?= isset($titulo) ? $titulo : 'Sociedades' ?></h1>
            </div>
