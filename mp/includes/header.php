...
<head>
    ...
    <title><?= isset($titulo) ? $titulo . ' — ' : '' ?>Mercado Pago · SmartAdmin</title>
    ...
    <aside class="sidebar" id="sidebar">
        <div class="sidebar-brand">
            ...
            <div>
                ...
                <div class="brand-sub">Mercado Pago</div>
            </div>
        </div>

        <nav class="sidebar-nav">
            <div class="nav-section-label">Principal</div>
            <a href="/mp/index.php" class="nav-item <?= $pagina_actual === 'index' ? 'active' : '' ?>">
                <span class="nav-icon">◈</span>
                <span>Dashboard</span>
            </a>
            <a href="/mp/procesar.php" class="nav-item <?= $pagina_actual === 'procesar' ? 'active' : '' ?>">
                <span class="nav-icon">⬆</span>
            ...
            <a href="/mp/reportes.php" class="nav-item <?= $pagina_actual === 'reportes' ? 'active' : '' ?>">
                <span class="nav-icon">◎</span>
                <span>Reportes</span>
            </a>
        ...
        <div class="sidebar-footer">
            ...
            <div class="banco-badge" style="margin-top:10px">
                <span class="banco-dot" style="background:#009ee3"></span>
