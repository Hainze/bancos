...
<head>
    ...
    <title><?= isset($titulo) ? $titulo . ' — ' : '' ?>Cobranza · SmartAdmin</title>
    ...
    <aside class="sidebar" id="sidebar">
        <div class="sidebar-brand">
            ...
            <div>
                ...
                <div class="brand-sub">Cobranza</div>
            </div>
        </div>

        <nav class="sidebar-nav">
            <div class="nav-section-label">Principal</div>
            <a href="/cobranza/index.php" class="nav-item <?= $pagina_actual === 'index' ? 'active' : '' ?>">
                <span class="nav-icon">◈</span>
                <span>Dashboard</span>
            </a>
            <a href="/cobranza/procesar.php" class="nav-item <?= $pagina_actual === 'procesar' ? 'active' : '' ?>">
                <span class="nav-icon">⬆</span>
                <span>Subir Excel</span>
            </a>

            <div class="nav-section-label">Configuración</div>
            <a href="/cobranza/padrones.php" class="nav-item <?= $pagina_actual === 'padrones' ? 'active' : '' ?>">
                <span class="nav-icon">◎</span>
                <span>Padrones</span>
            </a>
