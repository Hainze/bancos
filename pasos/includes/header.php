...
<head>
    ...
    <title><?= isset($titulo) ? $titulo . ' — ' : '' ?>Guías · SmartAdmin</title>
    ...
    <aside class="sidebar" id="sidebar">
        <div class="sidebar-brand">
            ...
            <div>
                ...
                <div class="brand-sub">Guías</div>
            </div>
        </div>

        <nav class="sidebar-nav">
            <div class="nav-section-label">Principal</div>
            <a href="/pasos/index.php" class="nav-item <?= $pagina_actual === 'index' ? 'active' : '' ?>">
    ...
    <main class="main-content">
        <div class="topbar">
            <div class="topbar-left">
                ...
                <h1 class="page-title"><?= isset($titulo) ? $titulo : 'Guías' ?></h1>
            </div>
            <div class="topbar-right">
                <a href="/index.php" class="btn-hub" title="Hub de herramientas">⊞ Hub</a>
                <span class="period-indicator"><?= date('d/m/Y') ?></span>
            </div>
        </div>
