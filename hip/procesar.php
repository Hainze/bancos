...
<div class="grid-2" style="gap:24px">
    <div>
        <div class="card mb-24">
            <div class="card-title">Subir Archivo — Banco Hipotecario</div>
            ...
            <div class="upload-zone" id="upload-zone">
                ...
                <div class="upload-title">Arrastrar el Excel del Hipotecario aquí</div>
...
document.getElementById('btn-descargar').addEventListener('click',()=>{if(!processedData)return;window.location.href=`/hip/api/exportar_excel.php?tipo=movimientos&lote=${encodeURIComponent(processedData.lote)}`;});
</script>
