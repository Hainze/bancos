...
<div class="filter-bar">
    ...
    <div class="filter-bar-body">
        ...
        <div class="filter-actions">
            ...
            <a href="/hip/procesar.php" class="btn btn-success">⬆ Importar</a>
...
<div class="card">
    <div class="flex-between mb-16">
        ...
        <a href="/hip/movimientos.php" class="btn btn-secondary btn-sm">≡ Ver todos</a>
    </div>
...
<div class="modal-overlay" id="modal-limpiar">
    <div class="modal" style="max-width:420px">
        ...
        <p style="color:var(--sub);font-size:14px;margin-bottom:16px">Elimina todos los movimientos y lotes del <strong>Banco Hipotecario</strong>.</p>
