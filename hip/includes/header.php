...
<head>
    ...
    <title><?= isset($titulo) ? $titulo . ' — ' : '' ?>Banco Hipotecario · SmartAdmin</title>
    ...
    <aside class="sidebar" id="sidebar">
        <div class="sidebar-brand">
            ...
            <div>
                ...
                <div class="brand-sub">Banco Hipotecario</div>
            </div>
        </div>

        <nav class="sidebar-nav">
            <div class="nav-section-label">Principal</div>
            <a href="/hip/index.php" class="nav-item <?= $pagina_actual === 'index' ? 'active' : '' ?>">
                <span class="nav-icon">◈</span><span>Dashboard</span>
            </a>
            <a href="/hip/procesar.php" class="nav-item <?= $pagina_actual === 'procesar' ? 'active' : '' ?>">
                <span class="nav-icon">⬆</span><span>Importar Excel</span>
            </a>
            <a href="/hip/movimientos.php" class="nav-item <?= $pagina_actual === 'movimientos' ? 'active' : '' ?>">
                <span class="nav-icon">≡</span><span>Movimientos</span>
            </a>
            <a href="/hip/reportes.php" class="nav-item <?= $pagina_actual === 'reportes' ? 'active' : '' ?>">
