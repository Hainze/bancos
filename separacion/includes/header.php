...
<head>
    ...
    <title><?= isset($titulo) ? $titulo . ' — ' : '' ?>Separación · SmartAdmin</title>
    ...
    <aside class="sidebar" id="sidebar">
        <div class="sidebar-brand">
            ...
            <div>
                ...
                <div class="brand-sub">Separación</div>
            </div>
        </div>

        <nav class="sidebar-nav">
            <div class="nav-section-label">Principal</div>
            <a href="/separacion/index.php" class="nav-item <?= $pagina_actual === 'index' ? 'active' : '' ?>">
                <span class="nav-icon">✂</span>
                <span>Separar Comprobantes</span>
            </a>
        ...
        <div class="sidebar-footer">
            ...
            <div class="banco-badge" style="margin-top:10px">
                ...
                <span>Separación de Comprobantes</span>
            </div>
        </div>
    </aside>
    ...
    <main class="main-content">
        <div class="topbar">
            <div class="topbar-left">
                ...
                <h1 class="page-title"><?= isset($titulo) ? $titulo : 'Separación' ?></h1>
            </div>
