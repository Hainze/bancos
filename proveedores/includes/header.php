...
<head>
    ...
    <title><?= isset($titulo) ? $titulo . ' — ' : '' ?>Proveedores · SmartAdmin</title>
    ...
    <aside class="sidebar" id="sidebar">
        <div class="sidebar-brand">
            ...
            <div>
                ...
                <div class="brand-sub">Proveedores</div>
            </div>
        </div>

        <nav class="sidebar-nav">
            <div class="nav-section-label">Principal</div>
            <a href="/proveedores/index.php" class="nav-item <?= $pagina_actual === 'index' ? 'active' : '' ?>">
                <span class="nav-icon">◈</span>
                <span>Dashboard</span>
            </a>
            <a href="/proveedores/procesar.php" class="nav-item <?= $pagina_actual === 'procesar' ? 'active' : '' ?>">
                <span class="nav-icon">⬆</span>
                <span>Subir Excel</span>
            </a>

            <div class="nav-section-label">Configuración</div>
            <a href="/proveedores/padrones.php" class="nav-item <?= $pagina_actual === 'padrones' ? 'active' : '' ?>">
                <span class="nav-icon">◎</span>
        ...
        <div class="sidebar-footer">
            ...
            <div class="banco-badge" style="margin-top:10px">
                <span class="banco-dot" style="background:#ef4444"></span>
