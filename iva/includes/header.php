...
<head>
    ...
    <title><?= isset($titulo) ? $titulo . ' — ' : '' ?>Libro IVA · SmartAdmin</title>
    ...
    <aside class="sidebar" id="sidebar">
        <div class="sidebar-brand">
            ...
            <div>
                ...
                <div class="brand-sub">Libro IVA</div>
            </div>
        </div>

        <nav class="sidebar-nav">
            <div class="nav-section-label">Principal</div>
            <a href="/iva/index.php" class="nav-item <?= $pagina_actual === 'index' ? 'active' : '' ?>">
                <span class="nav-icon">◈</span>
                <span>Procesar ARCA</span>
            </a>
            <a href="/iva/historial.php" class="nav-item <?= $pagina_actual === 'historial' ? 'active' : '' ?>">
                <span class="nav-icon">≡</span>
                <span>Historial</span>
            </a>
        ...
        <div class="sidebar-footer">
            ...
            <div class="banco-badge" style="margin-top:10px">
                <span class="banco-dot" style="background:var(--purple,#8b5cf6)"></span>
                <span>AFIP / ARCA</span>
            </div>
        </div>
    </aside>
    ...
    <main class="main-content">
        <div class="topbar">
            <div class="topbar-left">
                ...
                <h1 class="page-title"><?= isset($titulo) ? $titulo : 'Libro IVA' ?></h1>
            </div>
