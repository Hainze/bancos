...
<head>
    ...
    <title><?= isset($titulo) ? $titulo . ' — ' : '' ?>Ganancias y Balances · SmartAdmin</title>
    ...
    <style>
        ...
        .cliente-badge-sidebar .cb-dot { width:7px;height:7px;border-radius:50%;background:var(--amber);flex-shrink:0; }
    ...
    <aside class="sidebar" id="sidebar">
        <div class="sidebar-brand">
            ...
            <div>
                ...
                <div class="brand-sub">Ganancias y Balances</div>
            </div>
        </div>
        ...
        <nav class="sidebar-nav">
            <div class="nav-section-label">Ejercicio</div>
            <a href="/ganancias/index.php" class="nav-item <?= $pagina_actual === 'index' ? 'active' : '' ?>">
                <span class="nav-icon">📑</span>
                <span>Balance de datos</span>
            </a>
        ...
        <div class="sidebar-footer">
            ...
            <div class="banco-badge" style="margin-top:10px">
                <span class="banco-dot" style="background:var(--amber)"></span>
                <span>ARCA · Bienes Personales</span>
            </div>
        </div>
    </aside>
    ...
    <main class="main-content">
        <div class="topbar">
            <div class="topbar-left">
                ...
                <h1 class="page-title"><?= isset($titulo) ? $titulo : 'Ganancias y Balances' ?></h1>
            </div>
            <div class="topbar-right">
                <?php if ($fact_cliente_id): ?>
                <span style="font-size:12px;color:var(--amber);padding:4px 12px;background:rgba(245,158,11,0.1);border:1px solid rgba(245,158,11,0.2);border-radius:20px">
